...
void SpawnStatic (int tilex, int tiley, int type)
{
	...
	{
	case block:
		actorat[tilex][tiley] = ACTORAT_INT(1);		// consider it a blocking tile
	case dressing:
		laststatobj->flags = 0;
		break;
...
void SpawnDoor (int tilex, int tiley, boolean vertical, int lock)
{
	...
	actorat[tilex][tiley] = ACTORAT_INT(doornum | 0x80);	// consider it a solid wall
...
//
	actorat[tilex][tiley] = ACTORAT_INT(door | 0x80);
}
...
void DoorClosing (int door)
{
	...
	if ( (ACTORAT_TO_INT(actorat[tilex][tiley]) != (door | 0x80))
...
void PushWall (int checkx, int checky, int dir)
{
	...
	case di_north:
		...
		actorat[checkx][checky-1] = ACTORAT_INT(tilemap[checkx][checky-1] = oldtile);
		break;
	...
	case di_east:
		...
		actorat[checkx+1][checky] = ACTORAT_INT(tilemap[checkx+1][checky] = oldtile);
		break;
...
void MovePWalls (void)
{
	...
	// block crossed into a new block
		...
		actorat[pwallx][pwally] = ACTORAT_INT(0);
		*(mapsegs[0]+farmapylookup[pwally]+pwallx) = player->areanumber+AREATILE;
		...
		else
		{
			...
			case di_north:
				...
				actorat[pwallx][pwally-1] = ACTORAT_INT(tilemap[pwallx][pwally-1] = oldtile);
				break;
			...
			case di_east:
				...
				actorat[pwallx+1][pwally] = ACTORAT_INT(tilemap[pwallx+1][pwally] = oldtile);
				break;
